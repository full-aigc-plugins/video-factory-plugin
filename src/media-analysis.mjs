...
export function classifyDetections({ blackLog, freezeLog, silenceLog, subtitleText, durationSeconds }) {
  return {
...
export function analyzeMedia(path, { durationSeconds, hasAudio = false, subtitlePath, timeoutMs = 120000 }) {
