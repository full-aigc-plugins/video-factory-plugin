...
```bash
node scripts/bump-plugin.mjs video-factory patch   # 文档/注释/小修复
node scripts/bump-plugin.mjs video-factory minor   # 新功能
node scripts/bump-plugin.mjs video-factory major   # 破坏性变更
```
